    ...
    <div className="mt-3">
      ...
      {post?.pollQuestion && (
        <div>
            ...
            {post?.pollOptions?.map((option, index) => {
              ...
              return (
                <li
                  ...
                  <div
                    className={`flex justify-between px-2 relative w-full bg-slate-400/20 border  rounded-sm ${
          ...
          {isPollOpinionVisible && <span>{post?.pollAnswer}</span>}
